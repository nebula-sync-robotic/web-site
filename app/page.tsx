      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <div className="mt-8 flex gap-4">
            ...
            <Link href="/about#contact" className="px-6 py-3 rounded-md border border-gray-700 text-sm hover:bg-white/5">Contact Sales</Link>
          </div>
        ...
        <div className="flex justify-center md:justify-end">
          <div className="relative w-[420px] h-[420px] hero-glow rounded-xl overflow-hidden card flex items-center justify-center">
            <Image src="/Nebula_Logo_t.png" alt="Nebula Logo" width={420} height={420} style={{objectFit:'contain'}} />
          </div>
        </div>
      </div>
...
function ProductCard({title, subtitle, desc}:{title:string, subtitle:string, desc:string}){
  return (
